...
public abstract class AbstractReportGenerator {
	...
	/**
	 * Returns the report definition used by this report generator. If this method
	 * returns <code>null</code>, the report generation process will throw a
	...
	/**
	 * Returns the data factory used by this report generator. If this method
	 * returns <code>null</code>, the report generation process will use the data
	 * factory used in the report definition.
	 *
	...
	/**
	 * Returns the set of parameters that will be passed to the report generation
	 * process. If there are no parameters required for report generation, this
	 * method may return either an empty or a <code>null</code> <code>Map</code>
	 *
     ...
     * it into the specified <code>outputFile</code>.
     *
     ...
     * @throws IllegalArgumentException indicates the required parameters were
     * not provided
    ...
    public void generateReport(final OutputType outputType, OutputStream outputStream)
        ...
        System.out.println("NAmespaces:   " + report.getAttributeExpressionNamespaces());        
