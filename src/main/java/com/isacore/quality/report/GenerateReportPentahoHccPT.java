...
//		final URL reportDefinitionURL = classloader.getResource(pa.toString());
	...
	public DataFactory getDataFactory() {
		...
		dataFactory.setQuery(QUERY_NAME, "select rht.report_title, rht.report_subtitle, SUBSTRING(p.product_itcdq,4,6) as report_code,\r\n" + 
				...
				"hh.hcch_sapcode, hh.hcch_date_order, hh.hcch_date, hh.hcch_analysis, hh.hcch_code, hh.hcch_comment, hh.hcch_date, hh.hcch_norm, hh.hcch_batch, hh.hcch_referral_guide,\r\n" + 
